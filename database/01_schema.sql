-- =============================================================================
-- CamTrace Core Schema for Oracle 19c — V2 TCL Naming
-- Camshaft Pre-Dispatch Inspection & Traceability System
-- Table naming: TCL = Traceability Control Log
-- =============================================================================
-- This is the authoritative schema. The application models (SQLAlchemy)
-- reference these exact table and column names.
-- Run in order: 01_schema.sql → 02_indexes_views.sql → 04_seed_data.sql
-- =============================================================================
...
-- =============================================================================
-- 10. TCL_CAM_PHOTO — Inline BLOB storage (no filesystem dependency)
-- =============================================================================
...
-- =============================================================================
-- 14. AUTO-UPDATE TRIGGERS for updated_at columns
-- =============================================================================
